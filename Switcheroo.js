const DEFAULT_LANG = {
    button: {
        add: "Asociar un personaje"
    },
    msg: {
        error: "Se ha producido un error durante el cambio.",
...
const DEFAULT_OPT = {
    ...
    deleteIcon: `×`,
    addIcon: `+`,
    errorMsg: 'Se ha producido un error durante el cambio.',
    confirmMsg: 'Confirmar el cambio de personaje',
    modal: {}
};
